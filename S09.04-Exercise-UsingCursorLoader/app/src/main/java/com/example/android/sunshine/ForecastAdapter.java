...
// TODO (7) Generate a weather summary with the date, description, high and low
        long dateInMs = mCursor.getLong(INDEX_WEATHER_DATE);
        // Get a human readable date
        String dateString = getFriendlyDateString(mContext, dateInMs, false);
        // Use the weather id to get the description
        ...
        // Read high temp
        double highCelsius = mCursor.getDouble(INDEX_WEATHER_MAX_TEMP);
        // Read lox temp
        double lowCelsius = mCursor.getDouble(INDEX_WEATHER_MIN_TEMP);
        // Format the temperature
        String highLowTmp = formatHighLows(mContext, highCelsius, lowCelsius);
        // Format the summary
        String weatherSummary = dateString + " - " + description + " - " + highLowTmp;
