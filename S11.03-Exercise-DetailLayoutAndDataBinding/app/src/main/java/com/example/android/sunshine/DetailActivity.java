...
import static com.example.android.sunshine.utilities.SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition;
...
//      TODO (7) Display the weather icon using mDetailBinding
         ...
         * Weather Icon *
         ****************/
        // Read the weather condition ID from the cursor.
        int weatherId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        // Use the utility method to determine the correct art
        int weatherImageId = getLargeArtResourceIdForWeatherCondition(weatherId);
        // Set the resource Id on the art Id to display the picture
